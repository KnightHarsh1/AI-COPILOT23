...
_SIGNATURES: List[_Signature] = [
    ...
    _Signature(
        ...
        header_patterns=_compiled(r'vendor', r'supplier', r'payee', r'incurred date', r'paid to',
                                  r'expense', r'expense category', r'bill to'),
        filename_patterns=_compiled(r'expense', r'purchase'),
        min_matches=1,
    ),
    _Signature(
        document_type='sales',
        header_patterns=_compiled(r'invoice date', r'invoice no', r'sale date', r'sale value', r'bill date',
                                  r'\brevenue\b', r'\bsales\b', r'order id', r'order no', r'order date',
                                  r'\bproduct\b', r'\bqty\b', r'quantity', r'\bprice\b', r'net sales'),
        filename_patterns=_compiled(r'sales', r'\border', r'revenue'),
        min_matches=2,
    ),
    _Signature(
        document_type='customer',
        header_patterns=_compiled(r'customer name', r'client name', r'email', r'phone', r'\bcustomer\b', r'contact'),
        filename_patterns=_compiled(r'customer', r'client'),
        min_matches=2,
    ),
]
